...
- Cap any list at 5. Past five, split "do now" vs "later" or "must" vs "nice". Shape the presentation, not the underlying analysis.
...
Replace idioms with literal actions: "we should tighten this up" -> name the file and the line.
